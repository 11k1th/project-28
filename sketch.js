...
function setup() {
	...
	dground=new Ground();
	stones=new Rock(100,460,3);
	mango1=new Mango(560,290,3);
	mango2=new Mango(815,325,3);
	mango3=new Mango(630,260,3);
	mango4=new Mango(690,200,3);
	mango5=new Mango(670,320,3);
	mango6=new Mango(740,250,3);
	mango7=new Mango(785,170,3);
	mango8=new Mango(840,260,3);
	mango9=new Mango(900,220,3);
	mango10=new Mango(940,305,3);

	attach=new Throw(stones.body,{x:100,y:465});

	tree=createSprite(735,368);
